        ...
        <script>
          ...
          document.write("<table><tr>");
            for(var i=1;i<=n;i++)
            {
                if(i==1)
                {
                    document.write("<td style='background-color:yellow;'>NULL</td><td id='arrow'><====></td><td>PREV</td><td id="+i+"></td><td>NEXT</td><td id='arrow'><====></td>");
            
                }
                else
                {
                    document.write("<td>PREV</td><td id="+i+"></td><td>NEXT</td><td id='arrow'><====></td>");
           ...
           document.write("<td style='background-color:yellow;'>NULL</td></tr></table>");
            ...
            function insert_ll()
            {
                ...
                document.getElementById(n1).setAttribute('style','background-color:pink');
                n1--;
                console.log("ss",n1);
