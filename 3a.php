...
<html>
    ...
    <body>
        ...
        <section >
          ...
          <div class="hey">
        <div style="padding-top:10%;padding-bottom: 5%" align='center' class="col-md-12 col-sm-12">
                    
      <h3 style="color:grey ">BFS-Working</h3>
        </div>
    </div>
          ...
          <div class="container">
               <div style="padding:5%" class="row">
                   <div style="float:right" class="col-md-5 col-sm-12">
                         <div style="padding-left: 50px;" class="wow fadeInRight about-image" data-wow-delay="0.4s">
                             <img width="550px" height="200px" src="images/bfs_working.gif" class="img-responsive" alt="">
                         </div>
                    </div>
                    <div class="col-md-5 col-sm-12">
                         <div class="about-info">
                              <div class="section-title wow fadeInLeft" data-wow-delay="0.4s">
                                   <h2 style="font-weight: bold;color: #424242">Working</h2>
                              </div>

                            <div style="text-align:justify;height:50%px" class="wow fadeInUp" data-wow-delay="0.4s">
