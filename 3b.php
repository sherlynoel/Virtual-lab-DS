...
<html>
    ...
    <body>
      ...
      <h3 style="color:grey ">DFS-Working</h3>
    </div>
        </div>
               ...
               <div style="padding:5%" class="row">
                   <div style="float:right" class="col-md-5 col-sm-12">
                         <div style="padding-left: 50px;" class="wow fadeInUp about-image" data-wow-delay="0.6s">
                             <img width="550px" height="200px" src="images/dfs_working.gif" class="img-responsive" alt="">
                         </div>
                    </div>
                    <div class="col-md-5 col-sm-12">
                        <div class="about-info">
                            ...
                            <div style="text-align:justify;height:200px" class="wow fadeInUp" data-wow-delay="0.4s">
